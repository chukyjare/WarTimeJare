...
public class File extends JPanel {
	 ...
	 * Create the panel.
	 */
	public File(FileInfo information) {
	...
	private void paintValues(FileInfo information) {
		ImageIcon sonidoEncendido = new ImageIcon(File.class.getResource(information.getIcon()));
